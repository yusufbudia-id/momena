...
export function Hero({ invitation }: SectionProps) {
  ...
  return (
    <section className="relative min-h-svh overflow-hidden bg-[#090b11] text-white">
      <div className="absolute inset-y-0 right-0 w-[74%] sm:w-[66%] lg:w-[58%]">
      ...
      <div className="relative mx-auto flex min-h-svh max-w-[1500px] flex-col justify-between px-5 py-6 sm:px-8 lg:px-12">
        ...
        <div className="grid items-end gap-8 pb-8 lg:grid-cols-[1fr_auto] lg:pb-12">
          <div className="relative z-10">
            <p className="mb-4 text-[10px] font-semibold tracking-[.35em] text-[#d8ff58] uppercase">
              Contemporary love story
            </p>
            <h1 className="max-w-5xl text-[clamp(5rem,18vw,12rem)] font-black leading-[.7] tracking-[-.085em] uppercase mix-blend-normal">
          ...
          {date && (
            <div className="relative z-10 grid w-fit grid-cols-[auto_auto] items-end gap-4 border-l border-white/14 bg-black/10 pl-5 backdrop-blur-[2px] sm:pl-7">
