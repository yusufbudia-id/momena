...
export type GiftItemInput = { method: GiftMethod; bankName?: string | null; accountNumber?: string | null; accountHolder?: string | null; ewalletName?: string | null; ewalletNumber?: string | null; note?: string | null };
export type InvitationSettingsInput = { showGallery?: boolean; showRsvp?: boolean; showGift?: boolean; showStory?: boolean; showVideo?: boolean; musicUrl?: string | null; templateVariant?: string | null; accentColor?: string | null };
