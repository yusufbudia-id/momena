...
const invitationBaseSchema = {
  ...
  coverImagePositionX: z.number().int().min(0).max(100).default(50),
  coverImagePositionY: z.number().int().min(0).max(100).default(50),
  ...
  groomPhotoPositionX: z.number().int().min(0).max(100).default(50),
  groomPhotoPositionY: z.number().int().min(0).max(100).default(50),
  ...
  bridePhotoPositionX: z.number().int().min(0).max(100).default(50),
  bridePhotoPositionY: z.number().int().min(0).max(100).default(50),
...
export const invitationWizardFormSchema = z.object({
  ...
  coverImagePositionX: invitationBaseSchema.coverImagePositionX,
  coverImagePositionY: invitationBaseSchema.coverImagePositionY,
  groomPhotoUrl: invitationBaseSchema.groomPhotoUrl,
  groomPhotoPublicId: invitationBaseSchema.groomPhotoPublicId,
  groomPhotoPositionX: invitationBaseSchema.groomPhotoPositionX,
  groomPhotoPositionY: invitationBaseSchema.groomPhotoPositionY,
  bridePhotoUrl: invitationBaseSchema.bridePhotoUrl,
  bridePhotoPublicId: invitationBaseSchema.bridePhotoPublicId,
  bridePhotoPositionX: invitationBaseSchema.bridePhotoPositionX,
  bridePhotoPositionY: invitationBaseSchema.bridePhotoPositionY,
